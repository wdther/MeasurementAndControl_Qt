...
//  '<S26>'  : 'pidmodel/Discrete PID Controller/Filter/Disc. Forward Euler Filter'
//  '<S27>'  : 'pidmodel/Discrete PID Controller/Filter ICs/Internal IC - Filter'
...
//  '<S33>'  : 'pidmodel/Discrete PID Controller/N Copy/Disabled'
//  '<S34>'  : 'pidmodel/Discrete PID Controller/N Gain/Internal Parameters'
